 ...
 * > load('[path-to-rhino_dom.js')
 * > window.location = '[absolute-path-to-some-local-html-file]'
 * ...
 *
 * The window.locaton MUST be set
 * refer to http://ejohn.org/blog/bringing-the-browser-to-the-server/ for more info
 */
